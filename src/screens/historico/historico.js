...
import { historicoFetch, changeHistorico } from '../../actions/AppAction'
            ...
            <View style={globalStyles.itemHistorico}>
                <TouchableOpacity onPress={() => false}>
                    <View style={globalStyles.alignHistorico}>
                        <Icon name={icone} style={[globalStyles.iconHistorico, { fontWeight: isBold, color: atividade.cor }]} />
        ...
        return (
            <Container style={{ backgroundColor: '#fff' }}>
                <Header androidStatusBarColor='#00695c' style={{ backgroundColor: globalStyles.bg, height: 70 }}>
                    <Left>
                        <Button transparent onPress={() => { this.updateHistorico(); goBack() }}>
                            <Icon name='arrow-back' />
                        </Button>
                    </Left>

                    <Body style={{ paddingLeft: 10 }}>
                        <Title style={{ fontSize: 20, width: 210 }}>Histórico de atividades</Title>
                    </Body>
...
export default connect(mapStateToProps, { historicoFetch, changeHistorico })(Historico)